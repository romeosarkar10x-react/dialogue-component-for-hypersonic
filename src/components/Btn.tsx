...
export default function Btn({
    ...
    return (
        <button
            ...
            title={title}
            className={[
                "inline-flex items-center justify-center gap-1.5 rounded text-xs font-medium transition-all duration-150 shrink-0",
                ...
                variant === "ghost" && "h-7 w-7 text-neutral-500 hover:text-neutral-200 hover:bg-neutral-800",
